...
const WaveAnimation = () => {
  ...
  return (
    <><div className="flex items-center justify-center h-14 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-l-full rounded-r-full w-3/4 mx-auto">
          <div className="border-l-2 border-blue-900 h-12" ></div>
          <h1 className="text-4xl font-bold text-white animate-wave custom-3d-text">Welcome to the</h1>
          <div className='icon'>
          ...
          <h1 className="text-4xl font-bold text-white animate-wave mb-2 custom-3d-text">resources surveyor</h1>
          <div className="border-l-2 border-blue-900 h-12"></div>
      </div>
        </>
